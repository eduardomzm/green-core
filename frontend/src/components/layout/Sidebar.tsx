  ...
  return (
    <>
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-full shadow-2xl lg:shadow-none">
        ...
        {/* User profile → opens account settings */}
        <div className="p-4 border-t border-gray-50">
          <button
            onClick={() => setSettingsOpen(true)}
            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-gray-50 transition-colors group text-left cursor-pointer"
          >
            <div className="w-8 h-8 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-xs font-black text-primary uppercase flex-shrink-0">
            ...
            <Settings className="w-4 h-4 text-gray-300 group-hover:text-gray-500 flex-shrink-0 transition-colors" />
          </button>
        </div>
      </aside>
